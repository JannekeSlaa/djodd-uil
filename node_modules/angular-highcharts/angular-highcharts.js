...
class ChartDirective {
    ...
    init() {
        if (this.chart instanceof Chart) {
            chart(this.el.nativeElement, this.chart.options, chart$$1 => {
                (/** @type {?} */ (this.chart)).initChartRef(chart$$1);
            });
            return;
        }
        if (this.chart instanceof StockChart) {
            stockChart(this.el.nativeElement, this.chart.options, chart$$1 => {
                (/** @type {?} */ (this.chart)).initChartRef(chart$$1);
            });
            return;
        }
        if (this.chart instanceof MapChart) {
            mapChart(this.el.nativeElement, this.chart.options, chart$$1 => {
                (/** @type {?} */ (this.chart)).initChartRef(chart$$1);
            });
            return;
        }
