...
MapChart = /** @class */ (function () {
     ...
     * @return {?}
     */
    MapChart.prototype.initChartRef = /**
     * @param {?} chart
     * @return {?}
     */
    function (chart$$1) {
...
StockChart = /** @class */ (function () {
     ...
     * @return {?}
     */
    StockChart.prototype.initChartRef = /**
     * @param {?} chart
     * @return {?}
     */
    function (chart$$1) {
...
var ChartDirective = /** @class */ (function () {
    ...
    function () {
        ...
        if (this.chart instanceof Chart) {
            chart(this.el.nativeElement, this.chart.options, function (chart$$1) {
                (/** @type {?} */ (_this.chart)).initChartRef(chart$$1);
            });
            return;
        }
        if (this.chart instanceof StockChart) {
            stockChart(this.el.nativeElement, this.chart.options, function (chart$$1) {
                (/** @type {?} */ (_this.chart)).initChartRef(chart$$1);
            });
            return;
        }
        if (this.chart instanceof MapChart) {
            mapChart(this.el.nativeElement, this.chart.options, function (chart$$1) {
                (/** @type {?} */ (_this.chart)).initChartRef(chart$$1);
            });
            return;
        }
