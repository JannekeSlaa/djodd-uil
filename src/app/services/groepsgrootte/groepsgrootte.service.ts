...
export class GroepsgrootteService {
  ...
  getGroepsgrootte(): Array<GroepsgroottePerLeerjaar> {
    ...
    const jsonString = '{"data":[{"leerjaar": "0", "onderbouw" : "11.5", "bovenbouw": "0"},{"leerjaar": "1", "onderbouw" : "0", "bovenbouw": "10"}, {"leerjaar": "2", "onderbouw" : "15", "bovenbouw": "0"}, {"leerjaar": "4", "onderbouw" : "35", "bovenbouw": "0"}, {"leerjaar": "8", "onderbouw" : "0", "bovenbouw": "20"}]}';
