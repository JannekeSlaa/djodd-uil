...
export class VerzuimService {
  ...
  getVerzuimPerStatus(): Array<VerzuimPerStatus> {
    ...
    const jsonString = '{"data":[{"label":"afgesloten","aantal_l":5,"aantal_lrv":0,"aantal_0":24,"aantal_v3":9},{"label":"geregistreerd","aantal_l":0,"aantal_lrv":1,"aantal_0":18,"aantal_v3":1},{"label":"In behandeling","aantal_l":0,"aantal_lrv":1,"aantal_0":1,"aantal_v3":0}]}';
